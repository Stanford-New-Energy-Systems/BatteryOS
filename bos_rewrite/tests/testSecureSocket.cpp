...
int main() {
    ...
    LOG() << "successfully set the status of battery 0" << std::endl;
    ...
    SecureClient bat3(65431, "bat3");
    SecureClient bat4(65431, "bat4");
    ...
    SecureClient bat6(65431, "bat6");
    SecureClient bat7(65431, "bat7");
